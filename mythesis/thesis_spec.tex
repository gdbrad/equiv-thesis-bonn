...
% \end{align}
\section{Wilson's QCD action on the Lattice }
Fermion fields live at every lattice site $n$ $\phi(x) \rightarrow \phi_n$; We connect these fermions with oriented link variables(direction matters!) in order to retain gauge invariance. 
\begin{center}
    \begin{tikzpicture}
        \draw[->, thick] (0,0) -- (4,0);
        \node at (0,0) [below] {$x$};

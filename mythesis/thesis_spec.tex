...
In essence, we perform LQCD calculations on some HPC cluster, encode known properties of QCD into some EFT (eg. Chiral perturbation theory, Baryon $\chi$PT, etc. which will not be discussed in this work) to make predictions abot the standard model. Modern computing power allows us to perform these at the physical pion mass. \todo{add details from my Brown final project for better summary}

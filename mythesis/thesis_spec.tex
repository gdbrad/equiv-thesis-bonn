...
%==============================================================================
\chapter{Hadron Spectroscopy on the Lattice}\label{sec:spec}
%==============================================================================
...
\end{equation}
We will present the distilled meson correlator for an isovector meson in Chapter 4.
...
The first order of business it to solve for the first $N_D$ eigenvectors with the smallest eigenvalues of the gauge-covariant Laplacian such that 

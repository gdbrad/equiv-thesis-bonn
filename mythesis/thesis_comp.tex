...
\end{equation} where $i$ is the rank of the distillation basis, $\alpha$ is a color index \todo{I think?} and $t$ is indexed along the temporal extent of the lattice. 
